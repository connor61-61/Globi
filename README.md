...
A working beta of the travel-discovery site you outlined: 30 countries with
overviews, tourism ratings, multiple cities and attractions each, a daily
budget calculator, an interactive map, a compare tool, and a wishlist. Dark,
glowing atlas theme. No build step, no framework, no dependencies beyond
Leaflet (for the map) — five files, plain HTML/CSS/JS, ready for GitHub
